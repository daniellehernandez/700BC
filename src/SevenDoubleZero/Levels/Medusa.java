...
public class Medusa extends BasicGameState {
    private Hero hero;
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        ai = new Artemis(350, true);
        bg = new Animation(new SpriteSheet("res/Maps/Medusa.png", 700, 500), 1500);
    ...
    public void render(GameContainer gc, StateBasedGame sbg, Graphics g) throws SlickException {
        if (!ended) {
            ...
            if (ai.getHealth() <= 0) {
                ...
                if (heart == null) {
                    int randomNum = (int) (Math.random() * (2500 + (heartExistence * 500)));
                    if (randomNum == 1) {
                        heart = new Heart();
                        heart.setY(0);
